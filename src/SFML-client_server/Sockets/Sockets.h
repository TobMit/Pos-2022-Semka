...
/**
 * Wrapper call for SFML networking
 */
class Sockets {
protected:
    /*
...
public:
     ...
     */
    virtual bool socketSend(sf::Packet *pPacket);
    /**
     * Send packet via socket
     * @param pPacket packet will be stored here
     * @return if was correct recieving
     */
    virtual bool socketReceive(sf::Packet *pPacket);
    /**
     ...
     */
    virtual bool socketConnect(std::string pIpAddress, int pPort);
    /**
     * Disconect from server
     */
    virtual void socketDisconect();
protected:
