...
int main()
{
    ...
    */
    ...
    int client;
    int portNum = 15000; // NOTE that the port number is same for both client and server
    bool isExit = false;
    int bufsize = 1024;
    char buffer[bufsize];
    ...
    */
    ...
    bcopy((char *)ipadresa->h_addr, (char *)&server_addr.sin_addr.s_addr, ipadresa->h_length);
